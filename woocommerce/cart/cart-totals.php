...
?>
<div class="basket_totals <?php if ( WC()->customer->has_calculated_shipping() ) echo 'calculated_shipping'; ?>">

	<?php do_action( 'woocommerce_before_cart_totals' ); ?>

	<h2 class = "basket_totals_title"><?php _e( 'Cart Totals', 'woocommerce' ); ?></h2>

	<table cellspacing="0" class = "basket_totals_table">

		<tr class="basket_totals_container">
			<th class ="basket_totals_label"><?php _e( 'Subtotal', 'woocommerce' ); ?></th>
			<td class ="basket_totals_amount"><?php wc_cart_totals_subtotal_html(); ?></td>
		</tr>

		<?php foreach ( WC()->cart->get_coupons( 'cart' ) as $code => $coupon ) : ?>
			<tr class="basket_totals_container coupon-<?php echo esc_attr( $code ); ?>">
